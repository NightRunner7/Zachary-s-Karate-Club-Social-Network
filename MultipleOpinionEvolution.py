...
probability_list = [0.01, 0.05, 0.1, 0.2, 0.4, 0.8, 1.0]
k_list = [5, 10, 20, 40, 80]
radicalMembers_list = [6, 20, 40, 80, 160]

for prob_val in probability_list:
    # for each probability
    for k_val in k_list:
        # for each k value
        for nrad in radicalMembers_list:

            # grap parameters
            members = 1000
            radical_members = nrad
            k = k_val
